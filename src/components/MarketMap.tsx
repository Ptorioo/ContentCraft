    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
        <div className="flex flex-wrap items-start gap-4">
          ...
          {colorBy === 'cluster' ? (
            <div className="bg-[#F5F2F7] border border-[#D4C9E0] rounded-lg p-3 max-w-md">
              <div className="flex items-start gap-2">
                <Info size={16} className="text-[#5A4A6F] mt-0.5 flex-shrink-0" />
                <div className="text-sm text-[#7A6B8F]">
                  <p className="font-semibold text-[#5A4A6F] mb-1">聚類說明</p>
                  <p>
                    品牌被自動分成 <span className="font-semibold">{mapData.clusters}</span> 個群組，每個群組代表相似的內容風格。
            ...
            <div className="flex items-center gap-2 text-sm text-gray-600">
              <Info size={16} />
              <span>顏色：綠色=新穎(低ATI)，紅色=平均(高ATI)</span>
            </div>
          )}
        </div>
      </div>
